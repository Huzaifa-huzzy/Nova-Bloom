    ...
    <footer className="bg-gray-900 text-white mt-20">
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              Your trusted online store for premium products with fast delivery
            ...
            <ul className="space-y-3 text-gray-400">
              {[
                ...
                <li key={cat}>
                  ...
                  >
                    <span className="w-1.5 h-1.5 bg-white rounded-full group-hover:scale-150 transition"></span>
                    {cat}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-400 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+15551234567" className="hover:text-gray-300 transition">
                  +1 (555) 123-4567
                </a>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a
                  href="mailto:support@mernshop.com"
            ...
            <div>
              ...
              <div className="flex">
                <input
                  ...
                  className="px-4 py-3 rounded-l-lg text-gray-800 flex-1 focus:outline-none focus:ring-2 focus:ring-gray-500"
                />
                <button className="bg-black px-5 py-3 rounded-r-lg hover:bg-gray-900 transition font-semibold">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p>© {currentYear} MERN Shop. All rights reserved.</p>
